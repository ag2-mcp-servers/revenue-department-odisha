...
class CertificateParameters(BaseModel):
    ...
    REGDNO: str = Field(..., description='Registration No', examples=['110818XXXX9'])
...
class RdcerCertificatePostRequest(BaseModel):
...
class RdcerCertificatePostResponse(BaseModel):
...
class RdcerCertificatePostResponse1(BaseModel):
...
class RdcerCertificatePostResponse2(BaseModel):
...
class RdcerCertificatePostResponse3(BaseModel):
...
class RdcerCertificatePostResponse4(BaseModel):
...
class RdcerCertificatePostResponse5(BaseModel):
...
class RdcerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class CertificateParameters1(BaseModel):
    khatano: str = Field(..., description='Khata No.', examples=['xxx1'])
    level1: str = Field(..., description='District', examples=['None'])
    level2: str = Field(..., description='Tahasil', examples=['None'])
    level3: str = Field(..., description='Village', examples=['None'])


class Ror1bCertificatePostRequest(BaseModel):
...
class Ror1bCertificatePostResponse(BaseModel):
...
class Ror1bCertificatePostResponse1(BaseModel):
...
class Ror1bCertificatePostResponse2(BaseModel):
...
class Ror1bCertificatePostResponse3(BaseModel):
...
class Ror1bCertificatePostResponse4(BaseModel):
...
class Ror1bCertificatePostResponse5(BaseModel):
...
class Ror1bCertificatePostResponse6(BaseModel):
